...
class MainFrame(wx.Frame):
    ...
    def initUI(self):
        ...
        self.buttonView = wx.Button(self.panel_init, -1, u"信息", pos=(10, 40))
    ...
    def visualization(self,event):
        ...
        self.panel_visualization = wx.Panel(self, pos=(0, 0), size=(150, 500))

        self._caidan1 = wx.Button(self.panel_visualization, label=u'导入数据', pos=(0, 0), size=(150, 30))
        self.panel_visualization.Bind(wx.EVT_BUTTON, self.Onclick_visualization, self._caidan1)
        self._caidan2 = wx.Button(self.panel_visualization, label=u'三视图映像', pos=(0, 30), size=(150, 30))
        self.panel_visualization.Bind(wx.EVT_BUTTON, self.Onclick_visualization, self._caidan2)
        self._caidan3 = wx.Button(self.panel_visualization, label=u'三维可视化', pos=(0, 60), size=(150, 30))
        ...
        wx.StaticBitmap(self.panel_visualization, -1, wx.Bitmap(self._background),pos=(0,90))  # 显示图像
    ...
    def OnReSampled(self,event):
        ...
        self.panel_reSampled = wx.Panel(self,pos=(0, 0), size=(800, 500))

        self._reSampled_caidan1 = wx.Button(self.panel_reSampled, label=u'输入路径', pos=(0, 0), size=(150, 30))
        self._reSampled_onlyRead_text_input_path = wx.TextCtrl(self.panel_reSampled, value="待读入...", style=wx.TE_READONLY, pos=(160, 2),size=(300, 25))
        self._reSampled_caidan1_look = wx.Button(self.panel_reSampled,label=u'查看',pos=(470,0),size=(80,30))
        ...
        self._reSampled_onlyRead_text_output_path = wx.TextCtrl(self.panel_reSampled, value="待读入...",style=wx.TE_READONLY, pos=(160, 32), size=(300, 25))
        self._reSampled_caidan2 = wx.Button(self.panel_reSampled, label=u'输出路径', pos=(0, 30), size=(150, 30))
        self._reSampled_caidan2_look = wx.Button(self.panel_reSampled, label=u'查看', pos=(470, 30), size=(80, 30))
        ...
        self._reSampled_onlyRead_text_exe = wx.TextCtrl(self.panel_reSampled, value="待读入...   默认为: 3.22,1.62,1.62",style=wx.TE_READONLY, pos=(160, 62), size=(300, 25))
        self._reSampled_caidan3 = wx.Button(self.panel_reSampled, label=u'体素间距', pos=(0, 60), size=(150, 30))
        self._reSampled_caidan3_exe = wx.Button(self.panel_reSampled, label=u'执行', pos=(470, 60), size=(80, 30))
        self._reSampled_static_text = wx.StaticText(self.panel_reSampled,pos=(160, 100), size=(500, 100))
        ...
        # self._reSampled_background = wx.Image("background.jpg", type=wx.BITMAP_TYPE_ANY, )
        # self._reSampled_background = self._reSampled_background.Rescale(150, 150)  # 改变图像大小
        # wx.StaticBitmap(self.panel_reSampled, -1, wx.Bitmap(self._reSampled_background),pos=(0,90))  # 显示图像
    ...
    def Onclick_reSampled_look(self, event):
        ...
        if event.GetEventObject() == self._reSampled_caidan3_exe:
            ...
            if not self.path_input or not self.path_output:
                ...
                self._reSampled_delBlack = wx.Button(self.panel_reSampled, label=u'去除黑片', pos=(160, 250), size=(80, 30))
