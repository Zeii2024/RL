...
class EnvAgent:
    ...
    def reset(self):
        self.position = self.initial_position # None handle
        ...
        self.old_position = None # self.position 
        self.old_direction = None # self.direction 
        self.moving = False
    ...
    #################################
    # 把agents初始信息的重新赋值放在这里，创建一个函数，传入保留的
    # 初始信息，重新赋值给agents
